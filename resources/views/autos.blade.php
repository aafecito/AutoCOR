                ...
                @foreach ($vehiculos as $vehiculo)
                    ...
                    <div class="detalles-vehiculo" style="display:none" data-auto-id="{{ $vehiculo->id }}">
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    <x-adminlte-card title="DESCRIPCION GENERAL" theme="dark"
                                        icon="fas fa-lg fa-moon">
                                        <p>Una detallada descripcion del vehiculo</p>
                                        <x-adminlte-card title="DETALLES TÉCNICOS" theme="dark"
                                            icon="fas fa-lg fa-moon">
                                        ...
                                        <x-adminlte-card title="DETALLES DE MANTENIMIENTO" theme="dark"
                                            icon="fas fa-lg fa-moon">
